...
#ifndef PROTOBUF_helloworld_2eproto_INCLUDED
#define PROTOBUF_helloworld_2eproto_INCLUDED
...
namespace google {
namespace protobuf {
template<> ::helloworld::HelloReply* Arena::Create< ::helloworld::HelloReply>(Arena*);
template<> ::helloworld::HelloRequest* Arena::Create< ::helloworld::HelloRequest>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace helloworld {
...
class HelloRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:helloworld.HelloRequest) */ {
 public:
  ...
  inline HelloRequest* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<HelloRequest>(NULL);
  }

  HelloRequest* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<HelloRequest>(arena);
  }
...
class HelloReply : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:helloworld.HelloReply) */ {
 public:
  ...
  inline HelloReply* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<HelloReply>(NULL);
  }

  HelloReply* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<HelloReply>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
#endif  // PROTOBUF_helloworld_2eproto_INCLUDED
